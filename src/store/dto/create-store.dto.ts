...
export class CreateStoreDto {
  ...
  @ApiProperty({example: 'sixshop', description: '고객 관련 사용자 정의 필드 ID'})
  customerCustomFieldIds: CustomField[];

  @ApiProperty({example: 'sixshop', description: '상품 관련 사용자 정의 필드 ID'})
  productCustomFieldIds: CustomField[];

  @ApiProperty({example: 'sixshop', description: '주문 관련 사용자 정의 필드 ID'})
